...
export const RecruiterShedule = () => {
    ...
    const initialFun = () => {
      axios
        .get(
          `api/v1/interview?stage=schedule&size=20&from=0`
        )
        .then((res) => {
          ...
          <Modal.Body>
            <div className="p-3">
              ...
              <Col lg="12">
                ...
                //   }
                >
                  <option hidden="">Select </option><option value="ONLINE">Online</option><option value="IN_PERSON">In Person</option>
                </Form.Select>
                  {/* {errors && errors.timestamp && (
                    <p style={{ color: "red" }}>{errors.timestamp}</p>
                  )} */}
    ...
    function MyVerticallyCenteredDecline(props) {
      ...
      return (
        <div>
          ...
          >
            <Modal.Header closeButton>
              <Modal.Title style={{ color: "black" }}>Decline Interview</Modal.Title>
            </Modal.Header>
            <Modal.Body>
              <Row>
