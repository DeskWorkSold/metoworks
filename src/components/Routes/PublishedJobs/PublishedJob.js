  ...
  const MyVerticallyCenteredModalPublish = useCallback(
    ...
    const profileFunc = () => {
      ...
      const data = {
        ...
        industry: jobData.industry ? jobData.industry : props?.props?._source?.industry,
        jobFunction: jobData.jobFunction ? jobData.jobFunction : props?.props?._source?.jobFunction,
        location: jobData.location ? jobData.location : props?.props?._source?.location,
        description: jobData.description ? jobData.description : props?.props?._source?.description,
        requirements: jobData.requirements ? jobData.requirements : props?.props?._source?.requirements,
        profession: jobData.profession ? jobData.profession : props?.props?._source?.profession,
        projectTimeline: {
          gte: jobData.projectTimelineGte ? jobData.projectTimelineGte : props?.props?._source?.projectTimeline.gte,
          lte: jobData.projectTimelineLte ?  jobData.projectTimelineLte : props?.props?._source?.projectTimeline.lte,
        },
        noOfOpenings: jobData.noOfOpenings.toString() ? jobData.noOfOpenings.toString() : props?.props?._source?.noOfOpenings.toString(),
        postedDate: props?.props?._source?.postedDate.substring(0, 10),
        "closed": false,
        modeOfWork: jobData.modeOfWork ? jobData.modeOfWork : props?.props?._source?.modeOfWork,
        "submitted": true,
        educationLevel: jobData.educationLevel ? jobData.educationLevel : props?.props?._source?.educationLevel,
        empType: jobData.empType ? jobData.empType : props?.props?._source?.empType,
        ...
        id : props.props._id,
        jobSubFunction : jobData.jobSubFunction ? jobData.jobSubFunction : props?.props?._source?.jobSubFunction,
        salaryRange: {
          gte: isSalaryRange?.gte ? isSalaryRange?.gte : props?.props?._source?.salaryRange.gte,
          lte: isSalaryRange?.lte ? isSalaryRange?.lte : props?.props?._source?.salaryRange.lte
      }
    }
            ...
            <Col lg="12">
              <fieldset>
                ...
                <Form.Select
                  aria-label="Default select example"
                  onChange={(e) =>
                    jobData.industry = e.target.value
                  }
            ...
            <Col lg="12">
              <fieldset>
                ...
                <Form.Select
                  aria-label="Default select example"
                  onChange={(e) =>
                  jobData.location = e.target.value
                  }
                >
                  <option value="DEFAULT" disabled="">
                    Select Job Location
            ...
            <Col lg="12">
              <fieldset>
                ...
                <Form.Select
                  aria-label="Default select example"
                  onChange={(e) =>
                   jobData.empType = e.target.value
                  }
                >
                  <option value="DEFAULT" disabled="">Select Employment Type</option><option>PART TIME</option><option>CASUAL–NO SET HOURS OR DAYS OF WORK</option><option>PROJECT BASED</option><option>OTHER</option>
                </Form.Select>
                                ...
                                >
                                  ...
                                  >
                                    <div style={{ display: "block" }}>
                                      ...
                                      <p>
                                        Posted Date :{" "}
                                        {items?._source?.createdAt.substring(0,10)}
                                        &nbsp;&nbsp;&nbsp;Expiry Date :{" "}
                                        {items?._source?.expiryDate.substring(0,10)}
                                      </p>
                                    </div>
                                  </div>
                                </div>
